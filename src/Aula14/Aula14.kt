/*
Functions - as funções no Kotlin

(visibilidade) fun nomeDoMetodo(nome:String) : TipoDeRetorno {
    caso tenha retorno, haverá o "return"
}
 */

//Lambda
fun testeLambda(xpto: () -> String){
    println("A String da minha função anonima é a $xpto")
}
